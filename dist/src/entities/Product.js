...
let User = (() => {
    ...
    var User = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.products = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _products_initializers, void 0));
    ...
    (() => {
        ...
        _products_decorators = [(0, typeorm_1.OneToMany)(() => Product_1.Product, (product) => product.creator)];
