...
let Product = (() => {
    ...
    var Product = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.creatorId = (__runInitializers(this, _price_extraInitializers), __runInitializers(this, _creatorId_initializers, void 0));
            this.creator = (__runInitializers(this, _creatorId_extraInitializers), __runInitializers(this, _creator_initializers, void 0));
            this.createdAt = (__runInitializers(this, _creator_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (() => {
        ...
        _price_decorators = [(0, typeorm_1.Column)({ type: "decimal" })];
        _creatorId_decorators = [(0, typeorm_1.Column)()];
        _creator_decorators = [(0, typeorm_1.ManyToOne)(() => User_1.User, (user) => user.products)];
